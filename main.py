...
from pkg.application.usecases.find_project_use_case import FindProjectWithVerifiedInssuanceWithNoOwnerUseCase
...
project_use_case = FindProjectWithVerifiedInssuanceWithNoOwnerUseCase(
